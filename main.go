...
//go:generate bash -c "mkdir -p codegen/apiv1 && go run github.com/deepmap/oapi-codegen/cmd/oapi-codegen@v1.12.4 -generate types,server,spec -package apiv1 api/app_management/openapi_v1.yaml > codegen/apiv1/app_management_api_v1.go"
...
func main() {
	...
	go docker.UpdateRegistryMirror()
